...
/*=====
    ...
    note: calls:
        *   function next_ord_needed_id from CS 328 - Homework 3 - Problem 6
        *   function bool_to_string from CS 328 - Homework 2 - Problem 2
...
values
(next_ord_needed_id(), '9780201122305', 50, '15-Feb-2020');
