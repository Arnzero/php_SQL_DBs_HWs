...
prompt $60 - How to Design Programs: 15
...
prompt $35.95 - Operating Systems: A Systematic View: 5
prompt $37.95 - An Introduction to Database Systems: 10
prompt $37.95 - Data Base Management: 20
prompt $37.95 - Problem Solving and Structured Programming: 12
...
prompt ====> test passes if see NO output (parameters in wrong order):
prompt ===================
prompt
